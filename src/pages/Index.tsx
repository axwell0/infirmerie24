...
const testimonials = [
  {
    quote: "Excellent service et personnel a l’ecoute 🥰 …",
    name: "Asma Mammou"
  },
  {
    quote: "Excellent service, infirmiers qualifiés et accueillants. Je recommande",
    name: "Hadj Ali Mariem"
  },
  {
    quote: "Equipe professionnelle et bien déterminé et engagé.. Qui est toujours prêt à rendre service..\n" +
        "Service excellent, et un accueil chaleureux.\n" +
        "Bonne continuation",
    name: "Mahdi Ouerfelli",
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row items-center">
            <div className={`md:w-1/2 mb-10 md:mb-0 ${isVisible ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}>
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-medical-dark-blue leading-tight">
                Infirmerie24
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                ...
                />
                <Button variant="outline" className="border-medical-blue text-medical-blue hover:bg-medical-blue/5 w-full sm:w-auto sm:h-auto" asChild>
                  <a href="#services">Nos services</a>
                </Button>
              </div>
            </div>
      ...
      <section className="py-16 bg-gradient-to-br from-medical-light-green/5 to-medical-blue/5">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            ...
            <EquipmentCard icon={Briefcase} title="Concentrateur d'oxygène (10–5L)" />
            <EquipmentCard icon={Hospital} title="Aspirateur de mucosités" />
            <EquipmentCard icon={Syringe} title="Nébulisateur" />
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Votre partenaire de santé à domicile disponible 24h / 24 et 7 j / 7 dans le Grand Tunis.
              </p>
              <div className="flex gap-4">
                <a href="https://www.facebook.com/share/16EJPHykxX/" className="text-white hover:text-medical-light-green transition-colors">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path>
                  </svg>
                </a>
                <a href="https://www.instagram.com/Les_soins_rapides/" className="text-white hover:text-medical-light-green transition-colors">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
